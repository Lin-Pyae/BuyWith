...
<body>
    ...
    <div id="sub_content">
         ...
         <h2 class="col-md-6 offset-md-2 mb-5 ">Product Update</h2>
      ...
      <!--          <div class="col-md-4"> <br> <br> <br> <br>  <br> <br>  <br> 
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <form:input path="product_id" class="form-control"  id="productID" readonly="readonly"/>
                </div>
            </div>
            ...
            <div class="row mb-4">
             ...
             <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <form:textarea path="description" class="form-control" rows="4" cols="50" id="description" />
                </div>
            </div>
                ...
                <div class="col-md-4">
                    ...
                    <button type="button" class="btn btn-danger"  onclick="location.href='/BuyWith/return/${product_id}'">
                       ...
                       <span style="background-color:#f3d2b300">Back</span> 
                    </button>
