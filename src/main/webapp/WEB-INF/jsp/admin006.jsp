    ...
    <div id="sub_content">
		...
		<img id="image" style="width: 200px;height: 200px;background-image: url(icon.png);background-size: cover;border:none;" >
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <form:input path="product_id" class="form-control"  id="productID" disabled="true"/>
                </div>
            </div>
            ...
            <div class="row mb-4">
             ...
             <div class="row mb-4">
                ...
                <div class="col-md-4">
                        ...
                        <button type="button" class="btn btn-secondary" onclick="location.href='/BuyWith/P4update/${product_id}'">
