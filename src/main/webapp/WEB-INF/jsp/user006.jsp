...
<nav class="w3-sidebar w3-bar-block w3-text-black w3-light-grey w3-collapse w3-top" style="z-index:3;width:250px; background-color: #f3d2b3!important;" id="mySidebar">
  ...
  <div class=" w3-large w3-text-black w3-light-grey" style="font-weight:bold; padding-top:3px">
    <a href="buy with(shop).html" class="w3-bar-item w3-button w3-pink sidebar_item" style="margin-top:-3px; background-color: #f3d2b3!important;color: black!important;">Birthday Cakes</a>
    ...
    <a href="toppers.html" class="w3-bar-item w3-button sidebar_item topper" style="background-color: #e91e63;color:white;">Toppers</a>
  ...
  <div class="w3-row ">
    <div class="w3-col l3 s6">
      ...
      <div class="w3-container">
        ...
        <img src="./shop page/toppers1.jpg" class="img"  style="width:100%">
      ...
      <div style="margin-bottom: 16px; display: flex; justify-content: space-between;">
        <div><b class="product-name">Topper1</b><br><b class="product_price">1000</b></div>
        <div>
      ...
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/toppers2.jpg" class="img"  style="width:100%">
         <div class="w3-display-middle w3-display-hover ">
          <button class="w3-button w3-pink" id="addtoCart" onclick="addtoCart(this)">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
      <div style="margin-bottom: 16px; display: flex; justify-content: space-between;">
        <div><b class="product-name">Topper2</b><br><b class="product_price">650</b></div>
        <div>
          <div id="quantity_container" class=" col-4 align-self-center">
          <button onclick="decrease(this)" class="quantity_items dbtn" id="dbtn" style="border:none;"><i class="bi bi-dash fs-5 fw-bolder"></i></button>
          <label id="quantity" class="quantity_items quantity">0</label>
     ...
     <div class="w3-container">
        <div class="w3-display-container">
          <img src="./shop page/toppers3.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart<i class="fa fa-shopping-cart "></i></button>
          </div>
        </div>
        <p><b>Topper3</b><br><b>750MMK</b></p>
      </div>
    
      <div class="w3-container">
         <div class="w3-display-container">
         <img src="./shop page/toppers4.jpg" class="img" style="width:100%">
          <span class="w3-tag w3-display-topleft w3-yellow">New</span>
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
       </div>
        <p><b>Topper4</b><br><b>1000MMK</b></p>
      </div>
    </div>
     ...
     <div class="w3-col l3 s6">  
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/toppers5.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Topper5</b><br><b>800MMK</b></p>
      </div>
      
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/toppers6.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart<i class="fa fa-shopping-cart"></i></button>
          </div>
      </div>
        <p><b>Topper6</b><br><b class="w3-text-black">500MMK</b></p>
      </div>
  
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/toppers7.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Topper7</b><br><b class="w3-text-black">650MMK</b></p>
      </div>

      <div class="w3-container">
       <div class="w3-display-container">
        <img src="./shop page/toppers8.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Topper8</b><br><b>500MMK</b></p>
      </div>
    </div>
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/toppers9.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Topper9</b><br><b class="w3-text-black">450MMK</b></p>
      </div>
   
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/toppers10.jpg" class="img" style="width:100%">
        <span class="w3-tag w3-display-topleft w3-yellow">New</span>
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Topper10</b><br><b class="w3-text-black">700MMK</b></p>
      </div>

      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/toppers11.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart"></i></button>
          </div>
      </div>
        <p><b>Topper11</b><br><b class="w3-text-black">400MMK</b></p>
      </div>
      ...
      <div class="w3-container">
        ...
        <p><b>Topper12</b><br><b class="w3-text-black">650MMK</b></p>
      </div>
    </div>
     ...
     <div class="w3-col l3 s6">
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/toppers13.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Topper13</b><br><b class="w3-text-black">800MMK</b></p>
      </div>
   
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/toppers14.jpg" class="img" style="width:100%">
        <span class="w3-tag w3-display-topleft w3-yellow">New</span>
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Topper14</b><br><b class="w3-text-black">900MMK</b></p>
      </div>

      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/toppers15.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart"></i></button>
          </div>
      </div>
        <p><b>Topper15</b><br><b class="w3-text-black">700MMK</b></p>
      </div>
    
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/toppers16.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
         </div>
        <p><b>Topper16</b><br><b class="w3-text-black">800MMK</b></p>
      </div>
    </div>
  </div>
