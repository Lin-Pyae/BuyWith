            ...
            <div class="col-lg-4 profile-infos">
                ...
                <div class="card form-info">
                    <ul class="list-group text-center">
                        <li class="list-group-item list-group-item-danger border-start-0 text-success fw-bold text-capitalize" id="fullname"><c:out value="${user.getName()}" /></li>
                       <!--  <li class="list-group-item list-group-item-danger border-start-0 text-success fw-bold text-capitalize" id="idnumber">Id Number</li> -->
                        <li class="list-group-item list-group-item-danger border-start-0 text-success fw-bold text-capitalize" id="email"><c:out value="${user.getEmail()}" /></li>
                        ...
                        <li class="list-group-item list-group-item-danger text-center border-start-0">
                         <a href="/BuyWith/suu"><i class="far fa-envelope-open fs-5 text-dark noti-items"></i></a> 
                            <a href="/BuyWith/A7update" class="btn btn-success bg-transparent text-success fw-bolder" id="edit"><i class="feather-edit-2 fw-bold"></i> Edit Profile</a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-5 profile-edits" id="profiles">
                <form:form action="/BuyWith/A8update" method="post" modelAttribute="admin"  class="form-edits" id="profileForm" autocomplete="off">
                   <div>
                        ...
                        <form:input path="name"  class="form-control bg-transparent"  id="fname" placeholder="Enter Your Name" value="${user.getName()}" required='true'/>
                    </div>
                   
                    <div>
                        <label for="idno" class="form-label mt-2">ID Number</label>
                        <form:input path="admin_id" type="text" class="form-control bg-transparent" id="idno" placeholder="EG01" value="${user.getAdmin_id()}" readonly="readonly" required='true'/>
                    </div>
                    <div>
                        <label for="cemail" class="form-label mt-2">Email</label>
                        <form:input path="email" type="email" class="form-control text-white bg-transparent" id="cemail" value="${user.getEmail()}" placeholder="good12@gmail.com" required='true'/>
                    </div>
                    <div>
                        <label for="pwd" class="form-label mt-2">Password</label>
                        <form:input path="password" type="password" class="form-control bg-transparent" id="pwd" value="${user.getPassword()}" placeholder="Enter change password" required='true'/>
                    </div>
                    <div class="mt-3">
