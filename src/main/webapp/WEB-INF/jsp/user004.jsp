...
<nav class="w3-sidebar w3-bar-block w3-text-black w3-light-grey w3-collapse w3-top" style="z-index:3;width:250px; background-color: #f3d2b3!important;" id="mySidebar">
  ...
  <div class=" w3-large w3-text-black w3-light-grey" style="font-weight:bold; padding-top:3px; background-color: #f3d2b3!important;">
    <a href="buy with(shop).html" class="w3-bar-item w3-button w3-pink sidebar_item" style="background-color: #f3d2b3!important;color: black!important; margin-top: -3px;">Birthday Cakes</a>
    <a href="cupcakes.html" class="w3-bar-item w3-button sidebar_item">Cupcakes</a>
    <a href="desserts.html" class="w3-bar-item w3-button sidebar_item dessert" style="background-color: #e91e63;color:white;">Desserts</a>
...
<nav class="navbar navbar-expand-lg position-fixed w-100 " style="background-color:#f3d2b3 !important; z-index: 1500; top: 0;">
...
<br><br>
  ...
  <div class="w3-display-container w3-container w3-black">
   ...
   <h1 style="font-family:Georgia; color:#B82C54">Desserts</h1>
  ...
  <div class="w3-row ">
    <div class="w3-col l3 s6">
      ...
      <div class="w3-container">
        ...
        <img src="./shop page/desserts1.jpg" class="img" style="width:100%">
      ...
      <div style="margin-bottom: 16px; display: flex; justify-content: space-between;">
        <div><b class="product-name">Dessert1</b><br><b class="product_price">3000</b></div>
        <div>
      ...
      <div style="margin-bottom: 16px; display: flex; justify-content: space-between;">
        <div><b class="product-name">Dessert2</b><br><b class="product_price">2200</b></div>
        <div>
          <div id="quantity_container" class=" col-4 align-self-center">
          <button onclick="decrease(this)" class="quantity_items dbtn" id="dbtn" style="border:none;"><i class="bi bi-dash fs-5 fw-bolder"></i></button>
          <label id="quantity" class="quantity_items quantity">0</label>
     ...
     <div class="w3-container">
        <div class="w3-display-container">
          <img src="./shop page/desserts3.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
        </div>
        <p><b>Dessert3</b><br><b>3500MMK</b></p>
      </div>
    
      <div class="w3-container">
         <div class="w3-display-container">
         <img src="./shop page/desserts4.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
       </div>
        <p><b>Dessert4</b><br><b>4000MMK</b></p>
      </div>
    </div>
     ...
     <div class="w3-col l3 s6">  
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/desserts5.jpg" class="img" style="width:100%">
        <span class="w3-tag w3-display-topleft w3-yellow">New</span>
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Dessert5</b><br><b>2500MMK</b></p>
      </div>
      
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/desserts6.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart"></i></button>
          </div>
      </div>
        <p><b>Dessert6</b><br><b class="w3-text-black">2200MMK</b></p>
      </div>
  
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/desserts7.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Dessert7</b><br><b class="w3-text-black">3000MMK</b></p>
      </div>

      <div class="w3-container">
       <div class="w3-display-container">
        <img src="./shop page/desserts8.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Dessert8</b><br><b>3100MMK</b></p>
      </div>
    </div>
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/desserts9.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Dessert9</b><br><b class="w3-text-black">2500MMK</b></p>
      </div>
   
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/desserts10.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Dessert10</b><br><b class="w3-text-black">3500MMK</b></p>
      </div>

      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/desserts11.jpg" class="img" style="width:100%">
         <span class="w3-tag w3-display-topleft w3-yellow">New</span>
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart"></i></button>
          </div>
      </div>
        <p><b>Dessert11</b><br><b class="w3-text-black">3000MMK</b></p>
      </div>
    
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/desserts12.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
         </div>
        <p><b>Dessert12</b>Cake12<br><b class="w3-text-black">2500MMK</b></p>
      </div>
    </div>
     ...
     <div class="w3-col l3 s6">
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/desserts13.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Dessert13</b><br><b class="w3-text-black">3000MMK</b></p>
      </div>
   
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/desserts14.jpg" class="img" style="width:100%">
        <span class="w3-tag w3-display-topleft w3-yellow">New</span>
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart<i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Dessert14</b><br><b class="w3-text-black">2500MMK</b></p>
      </div>

      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/desserts15.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart"></i></button>
          </div>
      </div>
        <p><b>Dessert15</b><br><b class="w3-text-black">3000MMK</b></p>
      </div>
    
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/desserts16.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
         </div>
        <p><b>Dessert16</b><br><b class="w3-text-black">4000MMK</b></p>
      </div>
    </div>
  </div>
