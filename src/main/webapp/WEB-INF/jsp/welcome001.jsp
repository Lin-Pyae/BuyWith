 ...
 <nav class="navbar navbar-expand-lg position-fixed w-100 justify-content-between" style="background-color:#f3d2b3; z-index: 1500; top: 0;">
  ...
  <a class="navbar-brand ms-lg-5" href="#">
   ...
   <div class="  align-items-center ms-sm-5  d-lg-flex  d-none me-lg-5">
    <a href="home_page.html" class=" btn text-black btn-link nav-item">Home</a>
    <a href="loginform.html" class=" btn text-black btn-link nav-item">Shop</a>
    

    <a href="loginform.html" class=" btn text-black btn-link nav-item">Login</a>
    <a href="sign up form.html" class=" btn text-black btn-link nav-item">Sign Up</a> 
