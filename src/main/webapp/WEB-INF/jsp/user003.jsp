...
<nav class="w3-sidebar w3-bar-block w3-text-black w3-light-grey w3-collapse w3-top" style="z-index:3;width:250px; background-color: #f3d2b3!important;" id="mySidebar">
  ...
  <div class=" w3-large w3-text-black w3-light-grey" style="font-weight:bold; padding-top:3px">
    <a href="buy with(shop).html" class="w3-bar-item w3-button w3-pink sidebar_item" style="color: black!important; margin-top: -3px;">Birthday Cakes</a>
    <a href="cupcakes.html" class="w3-bar-item w3-button sidebar_item cupcake" style="background-color: #e91e63!important;color:white;">Cupcakes</a>
