...
<nav class="w3-sidebar w3-bar-block w3-text-black w3-light-grey w3-collapse w3-top" style="z-index:3;width:250px; background-color: #f3d2b3!important;" id="mySidebar">
  ...
  <div class=" w3-large w3-text-black w3-light-grey" style="font-weight:bold; padding-top:3px">
    ...
    <a href="macrons.html" class="w3-bar-item w3-button sidebar_item macron" style="background-color: #e91e63;color:white;">Macrons</a>
  ...
  <div class="w3-row ">
    <div class="w3-col l3 s6">
      <div class="w3-container">
        ...
        <img src="./shop page/macrons1.jpg" class="img"  style="width:100%">
      ...
      <div style="margin-bottom: 16px; display: flex; justify-content: space-between;">
        <div><b class="product-name">Macron1</b><br><b class="product_price">2500</b></div>
        <div>
      ...
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/macrons2.jpg" class="img"  style="width:100%">
         <div class="w3-display-middle w3-display-hover ">
          <button class="w3-button w3-pink" id="addtoCart" onclick="addtoCart(this)">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
      <div style="margin-bottom: 16px; display: flex; justify-content: space-between;">
        <div><b class="product-name">Macron2</b><br><b class="product_price">2000</b></div>
        <div>
          <div id="quantity_container" class=" col-4 align-self-center">
          <button onclick="decrease(this)" class="quantity_items dbtn" id="dbtn" style="border:none;"><i class="bi bi-dash fs-5 fw-bolder"></i></button>
          <label id="quantity" class="quantity_items quantity">0</label>
     ...
     <div class="w3-container">
        <div class="w3-display-container">
          <img src="./shop page/macrons3.jpg" class="img" style="width:100%">
        ...
        <p><b>Macron3</b><br><b>2pcs-2500MMK</b></p>
      </div>
    
      <div class="w3-container">
         <div class="w3-display-container">
         <img src="./shop page/macrons4.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart<i class="fa fa-shopping-cart "></i></button>
          </div>
       </div>
        <p><b>Macron4</b><br><b>3pcs-3500MMK</b></p>
      </div>
    </div>
     ...
     <div class="w3-col l3 s6">  
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/macrons5.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart<i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Macron5</b><br><b>2pcs-1500MMK</b></p>
      </div>
      
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/macrons6.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart"></i></button>
          </div>
      </div>
        <p><b>Macron6</b><br><b class="w3-text-black">3pcs-3500MMK</b></p>
      </div>
  
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/macrons7.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart<i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Macron7</b><br><b class="w3-text-black">3PCS-2500MMK</b></p>
      </div>

      <div class="w3-container">
       <div class="w3-display-container">
        <img src="./shop page/macrons8.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart<i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Macron8</b><br><b>3pcs-2500MMK</b></p>
      </div>
    </div>
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/macrons9.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Buy now <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Macron9</b><br><b class="w3-text-black">1pcs-1000MMK</b></p>
      </div>
   
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/macrons10.jpg" class="img" style="width:100%">
        <span class="w3-tag w3-display-topleft w3-yellow">New</span>
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Macron10</b><br><b class="w3-text-black">3pcs-2500MMK</b></p>
      </div>

      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/macrons11.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart"></i></button>
          </div>
      </div>
        <p><b>Macron11</b><br><b class="w3-text-black">3pcs-2000MMK</b></p>
      </div>
    
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/macrons12.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
         </div>
        <p><b>Macron12</b><br><b class="w3-text-black">2pcs-2500MMK</b></p>
      </div>
    </div>
     ...
     <div class="w3-col l3 s6">
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/macrons13.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Macron13</b><br><b class="w3-text-black">3pcs-2500MMK</b></p>
      </div>
      ...
      <div class="w3-container">
        ...
        <p><b>Macron14</b><br><b class="w3-text-black">3pcs-3500MMK/b></p>
      </div>

      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/macrons15.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart"></i></button>
          </div>
      </div>
        <p><b>Macron15</b><br><b class="w3-text-black">3pcs-2500MMK</b></p>
      </div>
    
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/macrons16.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart<i class="fa fa-shopping-cart "></i></button>
          </div>
         </div>
        <p><b>Macron16</b><br><b class="w3-text-black">3pcs-2000MMK</b></p>
      </div>
    </div>
  </div>
