    ...
    <header class="container-fluid">
        <div class="sidebars styles " id="sidebar">
            ...
            <ul class="list-group mb-0">
                <li class="list-group-item"><a href="./buy with(shop).html" class=""><i class="feather-shopping-cart me-2"></i>Shop</a></li>
                <li class="list-group-item"><a href="shop update.html" class=""><i class="feather-shopping-bag "></i> Manage Product</a></li>
                <li class="list-group-item"><a href="./Setting_2.html" class=""><i class="feather-settings me-2"></i>Setting</a></li>
                <li class="list-group-item"><a href="#" class=""><i class="feather-user me-2"></i>Add Admin</a></li>
                ...
                <div class="d-flex align-items-center justify-content-end profiles-details">
                    ...
                    <div class="dropdown ">
                        ...
                        <div class="dropdown-menu profile-drops drop-items">
                            ...
                            <a class="dropdown-item drop-items " href="./admin_profile.html">Profile</a>
