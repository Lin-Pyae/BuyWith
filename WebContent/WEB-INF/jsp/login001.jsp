  ...
  <body>
    <div class="main">
      ...
      <div class="container b-container" id="b-container">
        <form:form class="form" id="b-form" method="POST" action="/BuyWith/A4login" modelAttribute="admin">
         <!----<div class="form__icons">
          ...
          <form:input path="admin_id" class="form__input" type="text" placeholder="Email or Username" id="txt-check" />
