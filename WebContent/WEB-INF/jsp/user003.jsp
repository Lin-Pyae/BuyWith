...
.sidebar_item:focus{
  background-color: #B82C54!important;
}
...
<nav class="w3-sidebar w3-bar-block w3-text-black w3-light-grey w3-collapse w3-top" style="z-index:3;width:250px; background-color: #f3d2b3!important;" id="mySidebar">
  ...
  <div class=" w3-large w3-text-black w3-light-grey" style="font-weight:bold; padding-top:3px">
    <a href="/BuyWith/P10shop" class="w3-bar-item w3-button w3-pink sidebar_item" style="color: black!important; margin-top: -3px;">Birthday Cakes</a>
    <a href="/BuyWith/P6cup" class="w3-bar-item w3-button sidebar_item cupcake" style="background-color: #e91e63!important;color:white;">Cupcakes</a>
...
<br><br>
  ...
  <div class="w3-display-container w3-container w3-black">
    ...
    <div class="w3-display-topleft w3-text-white" style="padding:24px 48px">
     ...
     <h1 style="font-family:Georgia; color:#B82C54">Cupcakes</h1>
  ...
  <div class="w3-row ">
    <div class="w3-col l3 s6">
      ...
      <div class="w3-container">
        ...
        <div style="margin-bottom: 16px; display: flex; justify-content: space-between;">
          <div><b class="product-name">Cupcake1</b><br><b class="product_price">1500</b></div>
          <div>
      ...
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/cupcake2.jpg" class="img" style="width:100%">
         <div class="w3-display-middle w3-display-hover ">
          <button class="w3-button w3-pink" id="addtoCart" onclick="addtoCart(this)">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <div style="margin-bottom: 16px; display: flex; justify-content: space-between;">
          <div><b class="product-name">Cupcake2</b><br><b class="product_price">1000</b></div>
          <div>
            <div id="quantity_container" class=" col-4 align-self-center">
            <button onclick="decrease(this)" class="quantity_items dbtn" id="dbtn" style="border:none;"><i class="bi bi-dash fs-5 fw-bolder"></i></button>
            <label id="quantity" class="quantity_items quantity">0</label>
     ...
     <div class="w3-container">
        <div class="w3-display-container">
          <img src="./shop page/cupcake3.jpg" class="img" style="width:100%">
        ...
        <p><b>Cupcake3</b><br><b>2000MMK</b></p>
      </div>
    
      <div class="w3-container">
         <div class="w3-display-container">
         <img src="./shop page/cupcake4.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
       </div>
        <p><b>Cupcake4</b><br><b>1400MMK</b></p>
      </div>
    </div>
     ...
     <div class="w3-col l3 s6">  
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/cupcake5.jpg" class="img" style="width:100%">
        <span class="w3-tag w3-display-topleft w3-yellow">New</span>
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Cupcake5</b><br><b>1600MMK/b></p>
      </div>
      ...
      <div class="w3-container">
        ...
        <p><b>Cupcake6</b><br><b class="w3-text-black">2000MMK</b></p>
      </div>
  
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/cupcake7.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Cupcake7</b><br><b class="w3-text-black">1500MMK</b></p>
      </div>

      <div class="w3-container">
       <div class="w3-display-container">
        <img src="./shop page/cupcake8.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Cupcake8</b><br><b>1400MMK</b></p>
      </div>
    </div>
    ...
    <div class="w3-col l3 s6">
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/cupcake9.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Cupcake9</b><br><b class="w3-text-black">1600MMK</b></p>
      </div>
   
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/cupcake10.jpg" class="img" style="width:100%">
        <span class="w3-tag w3-display-topleft w3-yellow">New</span>
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Cupcake10</b><br><b class="w3-text-black">1500MMK</b></p>
      </div>

      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/cupcake11.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart"></i></button>
          </div>
      </div>
        <p><b>Cupcake11</b><br><b class="w3-text-black">1800MMK</b></p>
      </div>
    
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/cupcake12.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
         </div>
        <p><b>Cupcake12</b><br><b class="w3-text-black">1600MMK</b></p>
      </div>
    </div>
     ...
     <div class="w3-col l3 s6">
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/cupcake13.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Cupcake13</b><br><b class="w3-text-black">1300MMK</b></p>
      </div>
   
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/cupcake14.jpg" class="img" style="width:100%">
        <span class="w3-tag w3-display-topleft w3-yellow">New</span>
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
      </div>
        <p><b>Cupcake14</b><br><b class="w3-text-black">1200MMK</b></p>
      </div>

      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/cupcake15.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart"></i></button>
          </div>
      </div>
        <p><b>Cupcake15</b><br><b class="w3-text-black">1700MMK</b></p>
      </div>
    
      <div class="w3-container">
        <div class="w3-display-container">
        <img src="./shop page/cupcake16.jpg" class="img" style="width:100%">
          <div class="w3-display-middle w3-display-hover">
            <button class="w3-button w3-pink">Add to cart <i class="fa fa-shopping-cart "></i></button>
          </div>
         </div>
        <p><b>Cupcake16</b><br><b class="w3-text-black">1100MMK</b></p>
      </div>
    </div>
  </div>
